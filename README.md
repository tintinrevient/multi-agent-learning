...
<p float='left'>
	<img src='pix/matrix.png' width=700>
</p>

## Grand tables

There are in total 12 grand tables generated by different parameters, which are shown as following:
<p float='left'>
	<img src='pix/grand-table-params.png' width=700>
</p>
